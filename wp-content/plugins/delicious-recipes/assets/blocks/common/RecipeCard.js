				...
				>
						...
						<div className="dr-extra-meta">
							...
							<span className="dr-sim-metaa dr-cook-time">
								{recipe.prep_time && (
									<span className="dr-prep-time">
										<span className="dr-meta-title">
											{__("Prep Time", "delicious-recipes")}
										</span>
										<b>
											{recipe.prep_time +
												" " +
								...
								{recipe.cook_time && (
									<span className="dr-cook-time">
										<span className="dr-meta-title">
											{__("Cook Time", "delicious-recipes")}
										</span>
										<b>
											{recipe.cook_time +
												" " +
								...
								{recipe.rest_time && (
									<span className="dr-rest-time">
										<span className="dr-meta-title">
											{__("Rest Time", "delicious-recipes")}
										</span>
										<b>
											{recipe.rest_time +
												" " +
								...
								{recipe.total_time && (
									<span className="dr-total-time">
										...
										>
											{__("Total Time", "delicious-recipes")}
										</span>
							...
							{recipe.best_season && (
								<span className="dr-sim-metaa dr-season">
									<span className="dr-meta-title">
										{__("Best Season:", "delicious-recipes")}
									</span>
					...
					{recipe.notes && (
						<div className="dr-note">
							<h3 className="dr-title">{__("Notes", "delicious-recipes")}</h3>
							<p
								dangerouslySetInnerHTML={{
									__html: recipe.notes,
								}}
