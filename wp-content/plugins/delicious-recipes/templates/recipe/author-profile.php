    ...
    <?php endif; ?>
        ...
        <div class="author-social">
            <ul class="social-networks">
                <?php if ( $youtubeLink ) : ?>
                    <li class="youtube">
                        <a target="_blank" href="<?php echo esc_url( $youtubeLink ); ?>"><i class="fab fa-youtube"></i></a>
                    </li>
                <?php endif; ?>
                <?php if ( $facebookLink ) : ?>
                    <li class="facebook">
                        <a target="_blank" href="<?php echo esc_url( $facebookLink ); ?>"><i class="fab fa-facebook-f"></i></a>
                    </li>
                <?php endif; ?>
                <?php if ( $instagramLink ) : ?>
                    <li class="instagram">
                        <a target="_blank" href="<?php echo esc_url( $instagramLink ); ?>"><i class="fab fa-instagram"></i></a>
                    </li>
                <?php endif; ?>
                <?php if( $pinterestLink ) : ?>
                    <li class="pinterest">
                        <a target="_blank" href="<?php echo esc_url( $pinterestLink ); ?>"><i class="fab fa-pinterest-p"></i></a>
                    </li>
                <?php endif; ?>
                <?php if( $twitterLink ) : ?>
                    <li class="twitter">
                        <a target="_blank" href="<?php echo esc_url( $twitterLink ); ?>"><i class="fab fa-twitter"></i></a>
                    </li>
                <?php endif; ?>
                <?php if( $snapchatLink ) : ?>
                    <li class="snapchat">
                        <a target="_blank" href="<?php echo esc_url( $snapchatLink ); ?>"><i class="fab fa-snapchat"></i></a>
                    </li>
                <?php endif; ?>
                <?php if( $linkedinLink ) : ?>
                    <li class="linkedin">
                        <a target="_blank" href="<?php echo esc_url( $linkedinLink ); ?>"><i class="fab fa-linkedin"></i></a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
